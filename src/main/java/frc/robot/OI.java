...
import frc.robot.commands.ShiftLowGear;
...
public class OI {
	...
	private static Button shooterUp;
	private static Button shooterDown;
	...
	shooterUp = RobotMap.SHOOTER_UP_BUTTON;
	shooterDown = RobotMap.SHOOTER_DOWN_BUTTON;
